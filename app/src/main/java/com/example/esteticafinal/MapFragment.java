...
public class MapFragment extends Fragment {
     ...
     *
     * @param param11 Parameter 1.
     * @param param22 Parameter 2.
     * @return A new instance of fragment MapFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MapFragment newInstance(String param11, String param22) {
        MapFragment fragment = new MapFragment();
        Bundle args = new Bundle();
        args.putString(ARG_PARAM11, param11);
        args.putString(ARG_PARAM22, param22);
            ...
            public void onMapReady(@NonNull GoogleMap googleMap) {
                googleMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                    ...
                    public void onMapClick(@NonNull LatLng latLng) {
                        ...
                        LatLng sydney = new LatLng(19.658142797609866,  -99.2107406644656);
