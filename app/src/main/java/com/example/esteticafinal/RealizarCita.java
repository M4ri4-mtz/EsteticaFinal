...
import static com.example.esteticafinal.R.layout.custom_spinner;
...
TextView textViewType,textViewDate,textViewTime;
Spinner spinnerType,spinnerDate,spinnerTime;
    ...
    public void buttonSave(View view) {
        if (spinnerValidations()) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.Theme_EsteticaFinal);
    ...
    private long insertDate() {
        ...
        String correo_electronico = sharedPref.getString(getString(R.string.email), "");

        String tipo_sesión = spinnerType.getSelectedItem().toString().trim();
        String fecha_cita = spinnerDate.getSelectedItem().toString().trim() + " " + spinnerTime.getSelectedItem().toString().trim();
        ...
        values.put(Utilidades.CAMPO_TIPO_SESION, tipo_sesión);
        values.put(Utilidades.CAMPO_FECHA_CITA, fecha_cita);

        long id = bd.insert(Utilidades.TABLA_CITAS, Utilidades.CAMPO_ID_EMAIL, values);
